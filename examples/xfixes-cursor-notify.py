...
def main():
    ...
    while True:
        ...
        if (e.type, e.sub_code) == display.extension_event.DisplayCursorNotify:
            print(f"DisplayCursorNotify: cursor_serial={e.cursor_serial}")
            ...
            print(
                f"Cursor position={image.x},{image.y}, size={image.width}x{image.height}, xyhot={image.xhot},{image.yhot}, cursor_serial={image.cursor_serial}, cached={cached}"
            )
